...
class _DeliveryOptionsScreenState extends State<DeliveryOptionsScreen> {
  ...
  Widget _starMini(double rating) {
    return Row(mainAxisSize: MainAxisSize.min, children: [Icon(Icons.star, color: AppColors.amber, size: 12), SizedBox(width: 2), Text(rating.toString(), style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 11))]);
  }
